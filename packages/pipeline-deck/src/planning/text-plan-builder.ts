...
import {createClaimsFromDocument, createSourceQuotesFromDocument} from './document-artifacts.js'
import {inferDocumentSourceType} from './input.js'
import {normalizeLLMTextDeckSlides, type LLMTextDeckPlan} from './llm-plan.js'
import type {TextDeckProjectPlan, TextDeckProjectPlanOptions} from './types.js'
import {cleanGeneratedText, createTextMediaInfo, createTimedDeck, defaultSlideMotion, estimateNarrationDuration, resolveTheme, stripMarkdownControlText, truncateForLLM, visualKindForSlideType} from './utils.js'
import {createTextQualityIssues, summarizeQualityIssues} from '../quality/report.js'
import {deckSlideContentParts} from './slide-content.js'
