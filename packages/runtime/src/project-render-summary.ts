import type {RenderSummary} from './project-status-types.js'

import {readOptionalJson} from './file-io.js'
import {readArrayLength, readFiniteNumber, readIssueErrors, readIssueWarnings, type IssueCountLike} from './project-status-utils.js'
