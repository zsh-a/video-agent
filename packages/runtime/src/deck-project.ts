...
import type {QualityIssue, SubtitleQualityResult, VisualSmokeQualityResult} from '@video-agent/quality'
...
async function removeDeckFinalRenderArtifacts(workspace: ProjectWorkspace): Promise<void> {
  await Promise.all([
