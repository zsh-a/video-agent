...
- `serve` 命令：启动 Bun HTTP API server，暴露 Web Studio shell、health、provider-env、projects、status、events、artifacts、artifact preview、visual sample preview、render quality diagnostics、template quality diagnostics、artifact integrity diagnostics、stage rerun、workflow actions 和 worker recovery
