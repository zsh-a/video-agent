...
- `serve` 命令：启动 Bun HTTP API server，暴露 Web Studio shell、health、provider-env、projects、status、events、artifacts、artifact preview、visual sample preview、template quality diagnostics、stage rerun、workflow actions 和 worker recovery
