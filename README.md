...
bun run dev deck ./notes.md --source-type markdown --duration 3m --content-density balanced --max-slides 12 --project-id notes-demo
...
```sh
bun run dev deck ./notes.md --source-type markdown --duration 3m --content-density detailed --slide-count 10 --format portrait --style elegant-dark --project-id notes-demo
