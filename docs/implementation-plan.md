...
5. Record external agent client installation checks and docs for the Claude Code skill adapter.
6. Add real provider setup recipes once target services are selected.
